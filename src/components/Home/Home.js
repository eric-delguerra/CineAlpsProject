...
//const countDownDate = new Date("Feb 15, 2021 00:00:00").getTime();
...
const Home = () => (
    <ResponsiveContainer>
        {/*<Segment style={{ padding: '8em 0em', background: 'linear-gradient( #FF7C6A 50%, #FFFF )'}} vertical>*/}
        <Segment style={{ padding: '8em 0em', background: 'linear-gradient( 0deg, rgba(255,255,255,1) 0%, rgba(255,124,106,1) 100% )'}} vertical>

        {/*<Segment style={{ padding: '0em', height: '93vh' }} vertical>
            <Image src={process.env.PUBLIC_URL + "/color-women.jpg"} />*/}
